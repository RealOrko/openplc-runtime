 ...
 *
 * Phase 1 (Foundation): Config parsing, SOEM init, topology validation
 * Phase 2 (Future): Process data exchange in cycle_start/cycle_end
 */
 ...
 *
 * Phase 1: Stub - process data exchange will be implemented in Phase 2.
 * Phase 2 will: ec_send_processdata() + ec_receive_processdata(),
 *               then copy slave inputs to IEC located variables.
 */
void cycle_start(void)
{
    /* Phase 2: Read inputs from EtherCAT slaves */
}
 ...
 *
 * Phase 1: Stub - process data exchange will be implemented in Phase 2.
 * Phase 2 will: Copy IEC located variables to slave outputs,
 *               then ec_send_processdata().
 */
void cycle_end(void)
{
    /* Phase 2: Write outputs to EtherCAT slaves */
}
